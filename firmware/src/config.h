...
constexpr uint32_t THINK_TIMEOUT_MS    = 90000;   // give up waiting for the server after this
...
constexpr int      TRK_MIN_PIXELS      = 60;      // motion blobs smaller than this are noise (80x60 map)
...
constexpr float    TRK_GAIN            = 0.7f;    // fraction of the angular error corrected per step
